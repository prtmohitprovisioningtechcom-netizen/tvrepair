      ...
      <section className="container-wide section-pad bg-paper text-ink">
        <div className="grid grid-cols-1 md:grid-cols-[1fr_400px] lg:grid-cols-[1fr_500px] gap-8 lg:gap-12 items-start">
          <div>
            ...
            <ul className="list-disc pl-6 prose-site mt-2 text-muted">
          ...
          <div className="relative w-full aspect-4/3 rounded-2xl overflow-hidden shadow-xl md:sticky md:top-24">
            <CmsImage src="/images/site/tv-bench.jpg" alt="TV Repair Workshop" className="object-cover" sizes="(max-width: 768px) 100vw, 500px" />
          </div>
        </div>
      </section>
    </>
